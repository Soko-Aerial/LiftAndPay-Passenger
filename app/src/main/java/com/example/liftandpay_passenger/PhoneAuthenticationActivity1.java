...
public class PhoneAuthenticationActivity1 extends AppCompatActivity {
        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (phoneNumber.isEmpty())
                    Toast.makeText(PhoneAuthenticationActivity1.this, "Enter your phone number", Toast.LENGTH_SHORT).show();
                else {
                    //verify phone number
                    PhoneAuthProvider.getInstance().verifyPhoneNumber(
                            "+233"+phoneNumber, 60, TimeUnit.SECONDS, PhoneAuthenticationActivity1.this,
                            new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                                ...
                                public void onCodeSent(final String verificationId, PhoneAuthProvider.ForceResendingToken forceResendingToken) {
                                    ...
                                    //
                                    Dialog dialog = new Dialog(PhoneAuthenticationActivity1.this);
                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(task.isSuccessful()){
                            startActivity(new Intent(PhoneAuthenticationActivity1.this,PassengerSignUpActivity.class));
                            finish();
                        }else {
